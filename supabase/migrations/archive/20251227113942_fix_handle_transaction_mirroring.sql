-- Corrigir função com declaração correta de variáveis
...
DECLARE
  ...
  v_mirror_id UUID;
  v_payer_name TEXT;
  v_target_user_id UUID;  -- Variável simples em vez de RECORD
BEGIN
  -- Anti-loop
  ...
  LOOP
    ...
    -- Só criar espelho se membro tem user_id e não é o criador
