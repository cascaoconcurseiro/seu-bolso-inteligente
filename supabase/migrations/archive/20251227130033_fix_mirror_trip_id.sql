-- Corrigir função de espelhamento para manter trip_id
...
BEGIN
  ...
  IF TG_OP = 'UPDATE' THEN
    ...
    SET
      ...
      date = NEW.date,
      type = NEW.type,
      trip_id = NEW.trip_id,  -- MANTER trip_id sincronizado
      updated_at = NOW()
    ...
    IF v_target_user_id IS NOT NULL 
      ...
      IF v_mirror_id IS NULL THEN
        ...
        INSERT INTO transactions (
          ...
          account_id,
          category_id,
          trip_id,  -- MANTER trip_id da original
          is_shared,
          payer_id,
