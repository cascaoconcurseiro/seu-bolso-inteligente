...
BEGIN
    ...
    -- 3. Buscar nome do pagador e seu member_id
    SELECT COALESCE(full_name, email) INTO v_payer_name
    FROM public.profiles
    WHERE id = v_transaction.user_id;
    
    -- Buscar member_id do pagador
    SELECT id INTO v_payer_member_id
    FROM public.family_members
    WHERE user_id = v_transaction.user_id OR linked_user_id = v_transaction.user_id
    LIMIT 1;
    ...
    LOOP
        ...
        ELSE
            ...
            INSERT INTO public.transactions (
                ...
                NULL,
                true,
                v_payer_member_id,  -- CORRIGIDO: usar member_id ao invés de user_id
                p_transaction_id,
