-- Corrigir payer_id para usar NULL (sanitizado)
    ...
    IF v_target_user_id IS NOT NULL 
      ...
      IF v_mirror_id IS NULL THEN
        ...
        INSERT INTO transactions (
          ...
          NEW.date,
          NEW.type,
          NULL,  -- account_id sanitizado
          NULL,  -- category_id sanitizado
          NULL,  -- trip_id sanitizado
          TRUE,
          NULL,  -- payer_id sanitizado (evita FK error)
          NEW.id,
