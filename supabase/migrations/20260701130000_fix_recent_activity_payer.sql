-- Remove payer_id IS NULL restriction from dashboard recent activity CTE
-- so shared expenses where the user is the payer also appear.
-- Frontend already filters by creator/payer visibility.
