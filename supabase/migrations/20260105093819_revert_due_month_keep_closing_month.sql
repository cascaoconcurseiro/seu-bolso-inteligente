-- =====================================================
-- MIGRATION: Revert to closing month for competence_date
-- Data: 2026-01-05
-- Descrição: competence_date deve ser mês de FECHAMENTO (para cartões)
--            Compartilhados calcula mês de vencimento no frontend
-- =====================================================

-- Remover função de due month
DROP FUNCTION IF EXISTS public.calculate_credit_card_due_month(DATE, INTEGER, INTEGER);

-- Restaurar função original de competence_date (mês de fechamento)
...
-- Recalcular competence_date de todas as transações de cartão para mês de FECHAMENTO
