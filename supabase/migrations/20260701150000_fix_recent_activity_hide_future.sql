-- Hide future-dated transactions from the dashboard recent activity widget.
-- Only show transactions with date <= today, so future installments don't crowd
-- the "recent" list before they actually happen.
