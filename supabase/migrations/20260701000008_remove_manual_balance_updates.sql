-- ============================================================================
-- Migration: Remove Manual Balance Updates from Settlement Functions
-- Purpose: 
-- 1. The triggers update_account_balance_on_insert and 
--    update_account_balance_on_delete already handle balance updates.
-- 2. request_settlement and undo_settlement were manually updating balances
--    causing a double count. This migration removes the manual updates.
-- ============================================================================
...
BEGIN
  ...
  -- This insert WILL trigger update_account_balance_on_insert and update the balance automatically
...
BEGIN
    ...
    IF v_is_debtor THEN
        IF v_split.debtor_settlement_tx_id IS NOT NULL THEN
            ...
            -- The trigger update_account_balance_on_delete will automatically revert the balance!
