-- ============================================================================
-- Migration: Fix Request Settlement (Remove Audit Logs)
-- Purpose: The audit_logs table does not exist, causing the RPC to fail.
--          This removes the INSERT INTO audit_logs from request_settlement
--          and makes the is_settled assignment safer.
-- ============================================================================
