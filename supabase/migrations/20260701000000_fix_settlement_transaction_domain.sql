-- ============================================================================
-- Migration: Fix settlement transaction domain and description
-- Date: 2026-07-01
-- Purpose: Change settlement transactions to use SHARED domain and include (Acerto)
--          so they appear in the shared finances history correctly.
-- ============================================================================
