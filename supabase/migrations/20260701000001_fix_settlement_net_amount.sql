-- ============================================================================
-- Migration: Fix settlement net amount calculation
-- Date: 2026-07-01
-- Purpose: Calculate the net balance correctly when confirming or requesting
--          a settlement that contains a mix of debits and credits.
-- ============================================================================
