-- Migration: 20260616210000_dashboard_use_due_date_for_cc.sql
-- Corrige get_dashboard_summary e get_monthly_evolution_report para usar o mês de VENCIMENTO (due month)
-- para despesas de cartão de crédito. Isso implementa o Regime de Caixa correto no Dashboard e Relatórios,
-- onde os gastos do cartão aparecem somente no mês em que a fatura é paga (mês de vencimento), e não no mês de fechamento.
