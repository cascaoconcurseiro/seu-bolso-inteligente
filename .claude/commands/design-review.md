...
**Diferencial visual:** Verde-petróleo inspirado no ícone do Pé de Meia. Transmite controle financeiro, calma e confiança sem confundir a marca com os estados de entrada ou sucesso.
...
- **Accent/Primário light:** `176 77% 26%` (`#0F766E`, verde-petróleo profundo)
- **Accent/Primário dark:** `173 66% 50%` (`#2DD4BF`, verde-petróleo luminoso)
- **Foreground do accent:** branco no light; `179 84% 10%` (`#042F2E`) no dark. Sempre use `text-accent-foreground` ou `text-primary-foreground`, nunca `text-white` hardcoded.
...
- [ ] A cor de marca usa `--accent`/`--primary` (verde-petróleo) e não um hex ou uma classe Tailwind hardcoded?
