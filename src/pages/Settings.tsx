  ...
  return (
    <div className="space-y-8 pb-20">
      <header className="border-b border-border pb-5 md:pb-6">
        <p className="mb-1 text-sm font-medium text-primary">Preferências</p>
        <h1 className="font-display text-2xl font-semibold tracking-tight md:text-3xl">
          Configurações
        </h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Conta, segurança, categorias, notificações e privacidade
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 p-6 rounded-xl border border-border">
          ...
          {activeSection === "automations" && <AutoShareRulesSettings />}
            ...
            <div className="space-y-8 animate-fade-in">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Ferramentas administrativas e de integridade do sistema
                </p>
              </div>
              ...
              <div className="grid grid-cols-6 gap-2 max-h-[200px] overflow-y-auto p-1">
                {[
                  ...
                  <button
                    ...
                    className={cn(
                      "h-10 w-10 flex items-center justify-center rounded-lg border border-border hover:bg-muted transition-colors",
                      newCategoryIcon === icon && "bg-foreground text-background border-foreground"
                    )}
                  >
                    {icon}
                  </button>
      ...
      <AlertDialog open={showDeleteAccountDialog} onOpenChange={setShowDeleteAccountDialog}>
        <AlertDialogContent className="w-full sm:max-w-md !bottom-0 !top-auto !translate-y-0 sm:!top-[50%] sm:!bottom-auto sm:!-translate-y-1/2 rounded-t-[2rem] sm:!rounded-4xl !rounded-b-none sm:!rounded-b-[2rem] p-0 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] sm:shadow-lg max-h-[90vh] flex flex-col border-b-0 sm:border-b bg-background overflow-hidden">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta ação não pode ser desfeita. Todos os seus dados, transações, contas e categorias
              serão excluídos para sempre.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="py-4 space-y-3">
            <p className="text-sm font-medium">
              Para confirmar, digite <span className="font-bold text-destructive">EXCLUIR</span>{" "}
              abaixo:
            </p>
            <Input
              id="delete-confirm"
