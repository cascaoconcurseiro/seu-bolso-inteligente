            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="relative overflow-hidden rounded-2xl p-5 border border-border/50 bg-card/40 backdrop-blur-md shadow-sm hover:shadow-md transition-all duration-300 group">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="text-base font-black font-display tracking-tight mt-0.5 text-foreground truncate max-w-[150px]">
                      {largestExpense
                        ? formatCurrency(Number(largestExpense.amount), displayCurrency)
                ...
                <p
                  ...
                  title={largestExpense ? largestExpense.description : "Nenhum gasto"}
                >
              ...
              <div className="relative overflow-hidden rounded-2xl p-5 border border-border/50 bg-card/40 backdrop-blur-md shadow-sm hover:shadow-md transition-all duration-300 group">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="text-base font-black font-display tracking-tight mt-0.5 text-foreground truncate max-w-[150px]">
                      {topCategory
                        ? formatCurrency(topCategory.value, displayCurrency)
                        : formatCurrency(0, displayCurrency)}
                    </h3>
                  </div>
                </div>
                <p
                  className="text-sm text-muted-foreground mt-3 truncate font-medium max-w-[200px]"
                  title={topCategory ? topCategory.category : "Nenhum gasto"}
                >
              ...
              <div className="relative overflow-hidden rounded-2xl p-5 border border-border/50 bg-card/40 backdrop-blur-md shadow-sm hover:shadow-md transition-all duration-300 group">
                ...
                <div className="mt-3">
                  <span
                    className={`inline-block px-3 py-1 rounded-xl text-xs font-semibold border leading-tight ${savingsGoalStatus.color}`}
                  >
