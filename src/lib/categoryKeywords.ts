...
export const DEFAULT_KEYWORDS: Record<string, KeywordGroup[]> = {
  ...
  "Fast Food": [
    ...
    {
      keywords: ["fast food", "fastfood", "lanche rápido", "batata frita", "milkshake", "nuggets"],
      weight: 8,
    },
  ],
  ...
  Ônibus: [
    ...
    {
      keywords: ["bilhete único", "bilhete", "passagem", "valetransporte", "vale transporte"],
      weight: 7,
    },
  ],
  Metrô: [
  ...
  Farmácia: [
    ...
    {
      keywords: ["remédio", "remedio", "medicamento", "comprimido", "xarope", "pomada"],
      weight: 8,
    },
  ],
  Médico: [
  ...
  // ========== STREAMING ==========
  Netflix: [{ keywords: ["netflix", "netflix.com"], weight: 10 }],
  Spotify: [{ keywords: ["spotify", "spotify.com", "spotify premium"], weight: 10 }],
  "Amazon Prime": [
  ...
  "HBO Max": [{ keywords: ["hbo", "hbo max", "hbomax", "max.com", "hbo assinatura"], weight: 10 }],
  "YouTube Premium": [
    {
      keywords: ["youtube premium", "youtube.com/premium", "yt premium", "google youtube"],
      weight: 10,
    },
  ],
  "Apple Music": [
  ...
  Salário: [
    {
      keywords: [
        ...
        "remuneração",
        "remuneracao",
        "transferência recebida salario",
        "ted recebida",
  ...
  "13º Salário": [
    {
      keywords: ["13º", "13 salario", "13º salário", "décimo terceiro", "decimo terceiro"],
      weight: 10,
    },
  ],
  Dividendos: [
  ...
  "Aluguel Recebido": [
    {
      keywords: ["aluguel recebido", "locação recebida", "rent recebido", "quinto andar recebido"],
      weight: 10,
    },
  ],
  Reembolso: [
  ...
  Cashback: [
    {
      keywords: ["cashback", "cash back", "ame digital", "meliuz", "méliuz", "cashback nubank"],
      weight: 10,
    },
  ],
