      ...
      <Tabs defaultValue="bens-direitos" className="w-full space-y-6">
            ...
            <Card className="border-dashed border-2 py-12">
              <CardContent className="flex flex-col items-center justify-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground text-center max-w-sm">
                  Ativos só aparecem aqui se houver compras registradas até 31/12/{selectedYear} ou
                  saldo remanescente ativo.
                </p>
              </CardContent>
            </Card>
          ) : (
                  ...
                  >
                    <div className="bg-success/5 border-b border-border/50 px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          variant="secondary"
                          className="text-sm py-0 px-1.5 uppercase font-medium"
                        >
                          {asset.type}
                        </Badge>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 border-t pt-3">
                        <div className="space-y-0.5">
                          ...
                          <span className="text-sm font-display font-extrabold text-muted-foreground">
                            R${" "}
                            {posAnt.totalCost.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                          </span>
                          <span className="text-sm text-muted-foreground block">
                        ...
                        <div className="space-y-0.5 border-l pl-4">
                          ...
                          <span className="text-sm font-display font-extrabold text-success">
                            R${" "}
                            {posAtu.totalCost.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                          </span>
                          <span className="text-sm text-muted-foreground block">
        ...
        <TabsContent value="isentos" className="space-y-4">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Dividendos de ações, proventos de FIIs e rendimentos de renda fixa isenta
              (Poupança/LCI/LCA)
            </p>
          </div>
        ...
        <TabsContent value="tributado-exclusiva" className="space-y-4">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Juros sobre Capital Próprio (JCP) e rendimentos tributados retidos na fonte
              (CDB/Tesouro Direto)
            </p>
          </div>
