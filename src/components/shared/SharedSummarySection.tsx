...
interface SharedSummarySectionProps {
  totalsByCurrency: Record<
    string,
    { owedToMe: number; iOwe: number; balance: number; settled: number }
  >;
  travelTotalsByCurrency: Record<
    string,
    { owedToMe: number; iOwe: number; balance: number; settled: number }
  >;
...
export function SharedSummarySection({
  ...
  const showRegular =
    (activeTab === "REGULAR" || activeTab === "HISTORY") &&
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            ...
            <div className="p-4 md:p-6 rounded-xl border border-success/20 bg-success/5 hover:bg-success/12 transition-colors flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-2 md:mb-3">
                ...
                <p className="text-sm font-bold text-success/80 dark:text-success/80 uppercase tracking-widest">
                  A Receber
                </p>
              </div>
              <div className="space-y-2 flex-1 flex flex-col justify-center">
                ...
                {Object.values(totalsByCurrency).every((d) => d.owedToMe === 0) && (
                  <p className="text-muted-foreground/50 text-center text-sm py-2 font-mono">
                    R$ 0,00
                  </p>
                )}
              </div>
            ...
            <div className="p-4 md:p-6 rounded-xl border border-destructive/20 bg-destructive/5 hover:bg-destructive/12 transition-colors flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-2 md:mb-3">
                ...
                <p className="text-sm font-bold text-destructive/80 dark:text-destructive/80 uppercase tracking-widest">
                  A Pagar
                </p>
              </div>
              <div className="space-y-2 flex-1 flex flex-col justify-center">
