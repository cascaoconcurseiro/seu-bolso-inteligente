...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn("text-[13px] font-normal text-muted-foreground", className)} {...props} />
));
