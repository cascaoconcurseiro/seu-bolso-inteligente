            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-primary/5 text-sm text-muted-foreground border-b border-border font-medium">
                  <th className="pl-6 py-3.5 text-left uppercase tracking-wider">
                    Descrição das Contas Contábeis
                  </th>
                  <th className="pr-6 py-3.5 text-right uppercase tracking-wider w-[200px]">
                    Valor
                  </th>
                  <th className="pr-6 py-3.5 text-right uppercase tracking-wider w-[120px]">
                    Ações / Vert.
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border/40">
                <tr className="font-semibold text-foreground bg-muted/10 hover:bg-muted/20 transition-colors">
                  ...
                  <td className="pr-6 py-3 text-right font-mono text-success">
                    {formatCurrency(dreData.grossRevenue)}
                  </td>
                  <td className="pr-6 py-3 text-right text-sm text-muted-foreground font-mono">
                    100.0%
                  </td>
                </tr>
                ...
                <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors">
                  ...
                  <td className="pr-6 py-2.5 text-right font-mono text-success/80">
                    {formatCurrency(dreData.lines.OPERATIONAL_INC.total)}
                  </td>
                  <td className="pr-6 py-2.5 text-right">
                    <Button
                      ...
                      size="icon"
                      className="h-6 w-6"
                      onClick={() => toggleExpand("OPERATIONAL_INC")}
                    >
                      {expandedLines.OPERATIONAL_INC ? (
                ...
                <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors">
                  <td className="pl-10 py-2.5 text-left">
                    1.2 Receitas Financeiras / Investimentos
                  </td>
                  <td className="pr-6 py-2.5 text-right font-mono text-success/80">
                    {formatCurrency(dreData.lines.FINANCIAL_INC.total)}
                  </td>
                  <td className="pr-6 py-2.5 text-right">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-6 w-6"
                      onClick={() => toggleExpand("FINANCIAL_INC")}
                    >
                      {expandedLines.FINANCIAL_INC ? (
                        <EyeOff className="h-3.5 w-3.5" />
                      ) : (
                        <Eye className="h-3.5 w-3.5" />
                      )}
                ...
                <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors">
                  <td className="pl-6 py-3 text-left font-semibold text-foreground">
                    2. (-) ESTORNOS E DEDUÇÕES DO EXERCÍCIO
                  </td>
                  <td className="pr-6 py-3 text-right font-mono font-semibold text-destructive dark:text-destructive">
                    {formatNegativeCurrency(dreData.lines.DEDUCTION.total)}
                  </td>
                  <td className="pr-6 py-3 text-right">
                    <Button
                      ...
                      size="icon"
                      className="h-6 w-6"
                      onClick={() => toggleExpand("DEDUCTION")}
                    >
                      {expandedLines.DEDUCTION ? (
                        <EyeOff className="h-3.5 w-3.5" />
                      ) : (
                        <Eye className="h-3.5 w-3.5" />
                      )}
                ...
                <tr className="font-bold text-primary bg-primary/5 border-y border-primary/20">
                  ...
                  <td className="pr-6 py-3.5 text-right font-mono">
                ...
                <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors">
                  <td className="pl-6 py-3 text-left font-semibold text-foreground">
                    3. (-) CUSTOS OPERACIONAIS E CONSUMO VARIÁVEL
                  </td>
                  <td className="pr-6 py-3 text-right font-mono font-semibold text-destructive dark:text-destructive">
                    {formatNegativeCurrency(dreData.lines.VARIABLE_EXP.total)}
                  </td>
                  <td className="pr-6 py-3 text-right font-mono text-sm text-muted-foreground flex items-center justify-end gap-2">
                    <span>
                      {dreData.netRevenue > 0
                        ? ((dreData.lines.VARIABLE_EXP.total / dreData.netRevenue) * 100).toFixed(
                            1
                          ) + "%"
                        : "0.0%"}
                    </span>
                    <Button
                      ...
                      size="icon"
                      className="h-6 w-6"
                      onClick={() => toggleExpand("VARIABLE_EXP")}
                    >
                      {expandedLines.VARIABLE_EXP ? (
                        <EyeOff className="h-3.5 w-3.5" />
                      ) : (
                        <Eye className="h-3.5 w-3.5" />
                      )}
                ...
                <tr className="font-bold text-foreground bg-muted/5 border-y border-border/20">
                  ...
                  <td className="pr-6 py-3 text-right font-mono">
                ...
                <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors">
                  <td className="pl-6 py-3 text-left font-semibold text-foreground">
                    4. (-) DESPESAS ADMINISTRATIVAS E ESTRUTURA FIXA
                  </td>
                  <td className="pr-6 py-3 text-right font-mono font-semibold text-destructive dark:text-destructive">
                    {formatNegativeCurrency(dreData.lines.FIXED_EXP.total)}
                  </td>
                  <td className="pr-6 py-3 text-right font-mono text-sm text-muted-foreground flex items-center justify-end gap-2">
                    <span>
                      {dreData.netRevenue > 0
                        ? ((dreData.lines.FIXED_EXP.total / dreData.netRevenue) * 100).toFixed(1) +
                          "%"
                        : "0.0%"}
                    </span>
                    <Button
                      ...
                      size="icon"
                      className="h-6 w-6"
                      onClick={() => toggleExpand("FIXED_EXP")}
                    >
                      {expandedLines.FIXED_EXP ? (
                        <EyeOff className="h-3.5 w-3.5" />
                      ) : (
                        <Eye className="h-3.5 w-3.5" />
                      )}
                ...
                <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors">
                  <td className="pl-6 py-3 text-left font-semibold text-foreground">
                    5. (-) TARIFAS E DESPESAS FINANCEIRAS / TRIBUTOS
                  </td>
                  <td className="pr-6 py-3 text-right font-mono font-semibold text-destructive dark:text-destructive">
                    {formatNegativeCurrency(dreData.lines.FINANCIAL_EXP.total)}
                  </td>
                  <td className="pr-6 py-3 text-right">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-6 w-6"
                      onClick={() => toggleExpand("FINANCIAL_EXP")}
                    >
                      {expandedLines.FINANCIAL_EXP ? (
                        <EyeOff className="h-3.5 w-3.5" />
                      ) : (
                        <Eye className="h-3.5 w-3.5" />
                      )}
                ...
                <tr className="font-black text-base text-primary bg-primary/10 border-y-2 border-primary border-double">
                  <td className="pl-6 py-4 text-left uppercase tracking-tight">
                    (=) RESULTADO LÍQUIDO DO EXERCÍCIO (Economia Real)
                  </td>
                  <td className="pr-6 py-4 text-right font-mono text-primary">
                    {formatCurrency(dreData.netSavings)}
                  </td>
                  <td className="pr-6 py-4 text-right font-mono text-sm font-semibold">
                    {dreData.netRevenue > 0
                      ? ((dreData.netSavings / dreData.netRevenue) * 100).toFixed(1) + "%"
                      : "0.0%"}
                  </td>
                </tr>
              </tbody>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="p-5 border border-border bg-card/40 flex items-center gap-4 rounded-2xl shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Disponível para cobrir dívidas imediato
                </p>
              </div>
            </Card>
            ...
            <Card className="p-5 border border-border bg-card/40 flex items-center gap-4 rounded-2xl shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Proporção de ativos sob forma de dívida
                </p>
              </div>
            </Card>
            ...
            <Card className="p-5 border border-border bg-card/40 flex items-center gap-4 rounded-2xl shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Saldo do patrimônio líquido consolidado
                </p>
              </div>
            </Card>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-primary/5 text-sm text-muted-foreground border-b border-border font-medium">
                    <th className="pl-6 py-3.5 text-left uppercase tracking-wider">
                      Grupo Patrimonial (Contas do Balanço)
                    </th>
                    <th className="pr-6 py-3.5 text-right uppercase tracking-wider w-[200px]">
                      Saldo Consolidado
                    </th>
                ...
                <tbody className="divide-y divide-border/40">
                  ...
                  <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors font-medium">
                    <td className="pl-10 py-2.5 text-left">
                      1.1 Ativo Circulante (Disponibilidades)
                    </td>
                    <td className="pr-6 py-2.5 text-right font-mono">
                      {formatCurrency(b.assetCirculante)}
                    </td>
                    <td className="pr-6 py-2.5 text-right text-sm text-muted-foreground font-mono">
                      {b.totalAssets > 0
                        ? `${((b.assetCirculante / b.totalAssets) * 100).toFixed(1)}%`
                        : "0.0%"}
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-muted/30 text-sm text-muted-foreground border-b border-border/10 font-mono transition-colors">
                    <td className="pl-14 py-2 text-left">
                      1.1.1 Saldos em Conta Corrente / Carteira
                    </td>
                    <td className="pr-6 py-2 text-right">{formatCurrency(b.checkingChecking)}</td>
                    <td className="pr-6 py-2 text-right text-sm">
                      {b.assetCirculante > 0
                        ? `${((b.checkingChecking / b.assetCirculante) * 100).toFixed(1)}%`
                        : "0.0%"}
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-muted/30 text-sm text-muted-foreground border-b border-border/10 font-mono transition-colors">
                    <td className="pl-14 py-2 text-left">
                      1.1.2 Investimentos de Liquidez Diária / Poupança
                    </td>
                    <td className="pr-6 py-2 text-right">{formatCurrency(b.checkingSavings)}</td>
                    <td className="pr-6 py-2 text-right text-sm">
                      {b.assetCirculante > 0
                        ? `${((b.checkingSavings / b.assetCirculante) * 100).toFixed(1)}%`
                        : "0.0%"}
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors font-medium">
                    <td className="pl-10 py-2.5 text-left">
                      1.2 Ativo Não Circulante (Bens e Médio/Longo Prazo)
                    </td>
                    <td className="pr-6 py-2.5 text-right font-mono">
                      {formatCurrency(b.assetNaoCirculante)}
                    </td>
                    <td className="pr-6 py-2.5 text-right text-sm text-muted-foreground font-mono">
                      {b.totalAssets > 0
                        ? `${((b.assetNaoCirculante / b.totalAssets) * 100).toFixed(1)}%`
                        : "0.0%"}
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-muted/30 text-sm text-muted-foreground border-b border-border/10 font-mono transition-colors">
                    <td className="pl-14 py-2 text-left">
                      1.2.1 Contas de Investimento / Aplicações
                    </td>
                    <td className="pr-6 py-2 text-right">{formatCurrency(b.currentInvestments)}</td>
                    <td className="pr-6 py-2 text-right text-sm">
                      {b.assetNaoCirculante > 0
                        ? `${((b.currentInvestments / b.assetNaoCirculante) * 100).toFixed(1)}%`
                        : "0.0%"}
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-muted/30 text-sm text-muted-foreground border-b border-border/10 font-mono transition-colors">
                    <td className="pl-14 py-2 text-left">
                      1.2.2 Bens e Ativos de Investimentos Cadastrados
                    </td>
                    <td className="pr-6 py-2 text-right">{formatCurrency(b.physicalAssets)}</td>
                    <td className="pr-6 py-2 text-right text-sm">
                      {b.assetNaoCirculante > 0
                        ? `${((b.physicalAssets / b.assetNaoCirculante) * 100).toFixed(1)}%`
                        : "0.0%"}
                    </td>
                  </tr>
                  ...
                  <tr className="font-semibold text-foreground bg-muted/10 hover:bg-muted/20 transition-colors">
                    ...
                    <td className="pr-6 py-3 text-right font-mono text-destructive dark:text-destructive">
                      {formatNegativeCurrency(b.totalLiabilities)}
                    </td>
                    <td className="pr-6 py-3 text-right text-sm text-muted-foreground font-mono">
                      100.0%
                    </td>
                  ...
                  <tr className="hover:bg-muted/10 border-b border-border/20 transition-colors font-medium">
                    ...
                    <td className="pr-6 py-2.5 text-right font-mono text-destructive/90 dark:text-destructive/90">
                      {formatNegativeCurrency(b.totalLiabilities)}
                    </td>
                    <td className="pr-6 py-2.5 text-right text-sm text-muted-foreground font-mono">
                      100.0%
                  ...
                  <tr className="hover:bg-muted/30 text-sm text-muted-foreground border-b border-border/10 font-mono transition-colors">
                    <td className="pl-14 py-2 text-left">
                      2.1.1 Fatura Acumulada em Cartão de Crédito e Contas Negativas
                    </td>
                    <td className="pr-6 py-2 text-right text-destructive">
                      {formatNegativeCurrency(b.totalLiabilities)}
                    </td>
                  ...
                  <tr className="font-black text-base text-primary bg-primary/10 border-y-2 border-primary border-double">
                    <td className="pl-6 py-4 text-left uppercase tracking-tight">
                      (=) PATRIMÔNIO LÍQUIDO (Capital Líquido Consolidado)
                    </td>
                    <td className="pr-6 py-4 text-right font-mono text-primary">
                    ...
                    <td className="pr-6 py-4 text-right font-mono text-sm font-semibold">
                      {b.totalAssets > 0
                        ? `${((b.netWorth / b.totalAssets) * 100).toFixed(1)}%`
                        : "0.0%"}
                    </td>
                  </tr>
                </tbody>
