...
export function NotificationSettings({ preferences, isLoading, isUpdating, updatePreferences }: NotificationSettingsProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
            ...
            {isSupported && permission !== "denied" ? (
              ...
              >
                {subscribe.isPending || unsubscribe.isPending ? (
                  ...
                  <><Bell className="h-4 w-4 mr-1" />Ativar</>
                )}
              </Button>
            ) : (
          ...
          {hasSubscription && (
            <div className="pt-3 border-t space-y-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">O sistema enviará os lembretes próximo a este horário</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between py-2">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Todo domingo: gastos e saldo da semana</p>
                  </div>
                  <Switch
      ...
      <div className="space-y-3">
        <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Resumos in-app</h3>
        <div className="p-4 rounded-xl border border-border hover:border-foreground/20 transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">Resumo Semanal</p>
              <p className="text-sm text-muted-foreground">Relatório semanal das suas finanças no painel</p>
            </div>
