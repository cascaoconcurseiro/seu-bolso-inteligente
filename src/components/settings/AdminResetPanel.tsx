...
export function AdminResetPanel() {
  ...
  const {
    ...
    enrichedUsers,
    auditLogs, errorLogs, stats, searchQuery, setSearchQuery,
    selectedUser, setSelectedUser,
    confirmWord, setConfirmWord,
    showConfirmDialog, setShowConfirmDialog,
    isResetting, isLoadingStats, isLoadingUsers, isLoadingLogs, isLoadingErrorLogs, isPurging, isRecalculatingTarget, isResettingPassword, handleResetUserPassword,
    userDetailOpen, setUserDetailOpen,
    selectedDetailUser, detailAccounts, detailFamilies, isLoadingDetails, selectedErrorLog, setSelectedErrorLog,
