      ...
      <div className="mt-3 space-y-2">
        ...
        {milestones.length > 0 ? (
                  ...
                  <div key={m.id} className="flex items-center gap-2.5 pl-1 group/m">
                    ...
                    <span
                      className={cn(
                        "text-xs flex-1",
                        reached
                          ? "text-success font-medium line-through opacity-70"
                          : "text-foreground"
                      )}
                    >
                      {m.name}
          ...
          <p className="text-xs text-muted-foreground pl-1">
            Nenhum marco. Adicione % de progresso para celebrar conquistas.
          </p>
        ) : null}
      </div>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={() => {
                if (confirmDeleteId)
                  deleteMilestone.mutate({ id: confirmDeleteId, goalId: goal.id });
