...
export function TripDashboardView() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Hero Section */}
      <div className="relative overflow-hidden p-6 md:p-8 rounded-[2rem] border border-border/50 bg-gradient-to-br from-primary/10 via-background to-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-card/50 border-border/50 shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Registradas nesta viagem</p>
          </CardContent>
        </Card>
      </div>
      ...
      {transactions && transactions.length > 0 && (
        <div className="space-y-4">
          <h3 className="font-display font-semibold text-xl">Últimas Despesas</h3>
              ...
              <div key={tx.id} className="p-4 flex items-center justify-between hover:bg-muted/30 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{format(new Date(tx.date + 'T12:00:00'), "dd/MM/yyyy")}</p>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  {tx.is_shared && (
                    <Badge variant="outline" className="text-[10px] mt-1">Dividida</Badge>
                  )}
                </div>
              </div>
            ))}
