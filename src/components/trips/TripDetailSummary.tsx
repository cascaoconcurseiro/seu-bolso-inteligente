...
export function TripDetailSummary({
  ...
  const budgetUsagePercent = myPersonalBudget
    ? Math.min(100, (myTotalSpent / myPersonalBudget) * 100)
    : 0;
        ...
        <div className="relative z-10">
          {myPersonalBudget ? (
            <div className="space-y-2">
              ...
              <div className="space-y-2.5 mt-3">
                ...
                <div className="flex justify-between text-sm font-black uppercase tracking-widest">
                  <span
                    className={cn(
                      budgetUsagePercent > 90 ? "text-destructive" : "text-muted-foreground"
                    )}
                  >
                  ...
                  <span className="text-muted-foreground">
                    FALTA{" "}
                    {moneyUtils.format(Math.max(0, myPersonalBudget - myTotalSpent), currency)}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start gap-2 pt-2">
              <p className="text-sm font-bold text-muted-foreground/80">Sem orçamento definido</p>
