  ...
  public: {
    Tables: {
      ...
      financial_ledger: {
        ...
        Relationships: [
          {
            foreignKeyName: "financial_ledger_related_member_id_fkey"
          ...
          {
            foreignKeyName: "financial_ledger_related_user_id_fkey"
          ...
          {
            foreignKeyName: "financial_ledger_settlement_transaction_id_fkey"
    ...
    Functions: {
      ...
      recalculate_all_balances: { Args: { p_user_id: string }; Returns: number }
