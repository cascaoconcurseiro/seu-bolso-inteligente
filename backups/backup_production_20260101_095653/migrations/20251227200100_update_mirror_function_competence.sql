-- =====================================================
-- ATUALIZAR FUNÇÃO DE ESPELHAMENTO COM COMPETENCE_DATE
-- =====================================================
-- 
-- Garante que transações espelhadas também tenham
-- o campo competence_date correto
--
-- =====================================================
...
BEGIN
  ...
  IF TG_OP = 'UPDATE' THEN
    ...
    SET
      ...
      date = NEW.date,
      competence_date = NEW.competence_date, -- ADICIONAR competence_date
      type = NEW.type,
      trip_id = NEW.trip_id,
      updated_at = NOW()
    ...
    IF v_target_user_id IS NOT NULL 
      ...
      IF v_mirror_id IS NULL THEN
        ...
        INSERT INTO transactions (
          ...
          description,
          date,
          competence_date, -- ADICIONAR competence_date
          type,
          account_id,
          category_id,
          trip_id,
          ...
          NEW.date,
          NEW.competence_date, -- USAR competence_date da original
          NEW.type,
          NULL,
          NULL,
          NEW.trip_id,
...
COMMENT ON FUNCTION handle_transaction_mirroring IS 
'Função de espelhamento de transações compartilhadas. Atualizada para incluir competence_date.';
