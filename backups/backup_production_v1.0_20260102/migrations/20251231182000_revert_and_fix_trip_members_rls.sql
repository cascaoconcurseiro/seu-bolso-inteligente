-- REVERTER TODAS AS MUDANÇAS DE RLS E APLICAR CORREÇÃO SEGURA
-- Problema: Mudanças anteriores quebraram visualização de viagens
-- Solução: Restaurar estado original + correção apenas em trip_members_select
...
-- 2. Corrigir APENAS trip_members_select para permitir ver outros membros
