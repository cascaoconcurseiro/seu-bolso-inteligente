...
-- ============================================================================
-- NOTA IMPORTANTE SOBRE ORÇAMENTO DE VIAGEM
-- ============================================================================
-- 
-- Após análise, decidimos NÃO ajustar o orçamento automaticamente porque:
-- 
-- 1. ORÇAMENTO ≠ SALDO
--    - Orçamento é um LIMITE de gastos planejado
--    - Saldo é quanto cada pessoa deve/tem a receber
--    - São conceitos diferentes
-- 
-- 2. EXEMPLO:
--    - Viagem: Orçamento $ 100
--    - Wesley gasta $ 10 (compartilhado com Fran)
--    - Cada um deve pagar $ 5
--    - Fran acerta pagando $ 5 para Wesley
--    - Orçamento continua $ 100 (limite não muda)
--    - Gasto total continua $ 10
--    - Apenas a dívida entre eles foi quitada
-- 
-- 3. O QUE MUDA:
--    - Saldos individuais (já implementado via useSharedFinances)
--    - Status de pagamento (isPaid)
--    - Não o orçamento total da viagem
-- 
-- 4. SE QUISER IMPLEMENTAR NO FUTURO:
--    - Criar campo "available_budget" separado
--    - available_budget = budget - total_spent + total_settled
--    - Mostrar "Orçamento Disponível" vs "Orçamento Total"
-- 
-- ============================================================================
