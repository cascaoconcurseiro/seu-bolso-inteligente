...
-- Problema: A policy não considera linked_user_id, apenas user_id
...
COMMENT ON POLICY "family_members_can_view_based_on_role" ON transactions IS 
'Permite que membros da família vejam transações uns dos outros, considerando tanto user_id quanto linked_user_id';
